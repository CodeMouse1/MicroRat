 ...
 * wie Wall Follower und den kürzesten Pfad (Flood Fill-basiert) benötigt werden.
 *
 ...
 * Diese Funktion leitet den Roboter durch eine Sequenz von Drehungen und Bewegungen,
 ...
 * Der Roboter versucht, einer Wand auf der spezifizierten Seite zu folgen, um das Labyrinth zu erkunden.
...
/*
 * @brief Bestimmt die neue Orientierung des Roboters nach einer relativen Drehung.
 * @param current_orientation Die aktuelle Orientierung des Roboters.
 ...
 * @param currentX Die aktuelle X-Koordinate des Roboters.
 * @param currentY Die aktuelle Y-Koordinate des Roboters.
 * @param currentOrientation Die aktuelle Ausrichtung des Roboters.
